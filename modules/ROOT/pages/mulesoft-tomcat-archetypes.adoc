...
http://github.com/mulesoft/mulesoft-maven-archetypes[MuleSoft Maven Archetypes]

== Web Application Archetype Command Line Params

image::tomcat-archetypes-1.png[]
