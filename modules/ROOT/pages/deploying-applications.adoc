...
* Add applications directly into the repository using the xref:managing-the-repository.adoc[Repository tab] (administrator permissions are required).
* When developing an application, upload it to the repository as part of the build process using the xref:maven-publishing-plug-in.adoc[Maven Publishing Plug-in].
...
For information on managing an application, such as moving it from one location to another in the repository, see xref:managing-the-repository.adoc[Managing the Repository].
