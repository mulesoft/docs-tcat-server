...
After using the plugin to update your applications, you can schedule a script to listen for these updates and automatically redeploy their packages. For an example, see xref:scripting-examples.adoc[Automatically Redeploying After an Artifact Update].
