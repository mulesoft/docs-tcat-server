...
|xref:list-all-servers.adoc[GET] |/console/api/servers |Lists all servers on the resource
|===
...
|===
|Operation |Resource |Description
|xref:get-a-server.adoc[GET] |/console/api/servers/myServerId |Gets a server
|xref:register-a-server.adoc[POST] |/console/api/servers |Registers a new server
|xref:apply-a-profile-to-a-server.adoc[POST] |/console/api/servers/myServerId?profile=aProfileId |Applies a profile to a server
|xref:restart-a-server.adoc[POST] |/console/api/servers/myServerId/restart |Restarts a server
|xref:update-a-server.adoc[PUT] |/console/api/servers/myServerId |Updates a server
|xref:delete-a-server.adoc[DELETE] |/console/api/servers/myServerId |Deletes a server
|===
...
|===
|Operation |Resource |Description
|xref:get-a-file.adoc[GET] |/console/api/servers/myServerId/files/myFile.xml |Gets a file located on the server
|xref:get-file-metadata.adoc[GET] |/console/api/servers/myServerId/files/myFile.xml?metadata=true |Gets the metadata for a file located on the server
|xref:create-or-update-a-file.adoc[POST] |/console/api/servers/myServerId/files/myFile.xml |Updates or creates a file or directory located on the server
|xref:update-a-file.adoc[PUT] |/console/api/servers/myServerId/files/myFile.xml |Updates a file located on the server
|xref:delete-a-file.adoc[DELETE] |/console/api/servers/myServerId/files/myFile.xml |Deletes a file located on the server
|===
...
|===
|Operation |Resource |Description
|xref:list-all-server-groups.adoc[GET] |/console/api/serverGroups |Lists all server groups on the resource
|===
...
|===
|Operation |Resource |Description
|xref:create-a-server-group.adoc[POST] |/console/api/serverGroups |Creates a new server group
|xref:get-a-server-group.adoc[GET] |/console/api/serverGroups/serverGroupId |Gets a server group
|xref:apply-a-profile-to-a-server-group.adoc[POST] |/console/api/serverGroups/serverGroupId?profile=aProfileId |Applies a profile to a server group
|xref:update-a-server-group.adoc[PUT] |/console/api/serverGroups/serverGroupId |Updates a server group
|xref:delete-a-server-group.adoc[DELETE] |/console/api/serverGroups/serverGroupId |Deletes a server group
|===
...
|href |The URL of the application inside the repository. See the xref:repository-api.adoc[Repository API] for more details.
...
|===
|Operation |Resource |Description
|xref:list-all-deployments.adoc[GET] |/console/api/deployments |Gets a list of all deployments on the resource.
|===
...
|===
|Operation |Resource |Description
|xref:create-a-deployment.adoc[POST] |/console/api/deployments |Creates a new deployment
|xref:get-a-deployment.adoc[GET] |/console/api/deployments/deploymentId |Gets a deployment
|xref:update-a-deployment.adoc[PUT] |/console/api/deployments/deploymentId |Updates a deployment
|xref:get-the-deployment-history.adoc[GET] |/console/api/deployments/deploymentId/history |Gets the history for a deployment
|xref:get-the-deployment-version-details.adoc[GET] |/console/api/deployments/deploymentId/deploymentVersionId |Gets the details about a particular version of a deployment
|xref:redeploy-a-deployment.adoc[POST] |/console/api/deployments/deploymentId/redeploy |Redeploys a deployment
|xref:undeploy-a-deployment.adoc[POST] |/console/api/deployments/deploymentId/undeploy |Undeploys a deployment
|xref:delete-a-deployment.adoc[DELETE] |/console/api/deployments/deploymentId |Deletes a deployment
|===