...
image::server-dashboard.png[server_dashboard]
...
image::server-metric-portlet-config.png[server_metric_portlet_config]
...
image::chart-type-config.png[chart_type_config]
