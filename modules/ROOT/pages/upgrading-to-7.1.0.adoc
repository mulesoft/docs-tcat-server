...
. Download link:{attachmentsdir}/repository.xml[repository.xml] and put it in the *tcat-data* directory.
. Download link:{attachmentsdir}/new-repository.xml[new-repository.xml] and put it in the *work* directory.
