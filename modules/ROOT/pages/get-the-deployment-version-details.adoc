...
The GET operation retrieves the details for a particular deployment version. The URL is from the xref:get-the-deployment-history.adoc[deployment history resource].
